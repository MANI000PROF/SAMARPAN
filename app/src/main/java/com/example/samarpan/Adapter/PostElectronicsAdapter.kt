...
class PostElectronicsAdapter(
    private val context: Context,
    private var postList: MutableList<DonationPostsElectronics>,
    private var userLocation: Location? = null,
    private val onPostClick: (DonationPostsElectronics) -> Unit
) : RecyclerView.Adapter<PostElectronicsAdapter.PostViewHolder>() {

    inner class PostViewHolder(private val binding: PostItemBinding) :
        RecyclerView.ViewHolder(binding.root) {

        fun bind(post: DonationPostsElectronics) {
            binding.profileName.text = post.profileName ?: "Unknown"
            binding.location.text = post.location ?: "Unknown"
            binding.foodTitle.text = post.electronicsTitle ?: "Unknown" // Replace this with clothesTitle in XML for clothes posts
            post.timestamp.let {
            ...
            Glide.with(binding.foodImage.context)
                .load(post.electronicsImage ?: "") // You may want to change the foodImage reference to clothesImage
    ...
    private fun showOptionsDialog(post: DonationPostsElectronics) {
    ...
    private fun savePostToFirebase(post: DonationPostsElectronics) {
    ...
    fun updatePostList(newPosts: List<DonationPostsElectronics>, userLocation: Location?) {

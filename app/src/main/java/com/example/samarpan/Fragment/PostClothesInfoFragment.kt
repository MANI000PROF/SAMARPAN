...
class PostClothesInfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (currentUser != null && currentUser.uid == post.donorId) {
            ...
            binding.requestClothesBtn.text = "Your Post"
            binding.requestClothesBtn.alpha = 0.6f // Make it slightly faded
        }
    ...
    private fun sendClothesRequest() {
        ...
        val alert = post.clothesImage?.let {
            Alert(
                ...
                requesterTitle = "Your request for: ${post.clothesTitle ?: "post"}",
                postImageUrl = it
            )
        }
